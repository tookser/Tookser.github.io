...
return (function() { 
var G__11905__delegate = function (args){
...
while (G__11906__i < G__11906__a.length) {G__11906__a[G__11906__i] = arguments[G__11906__i + 0]; ++G__11906__i;}
  args = new cljs.core.IndexedSeq(G__11906__a,0,null);
} 
return G__11905__delegate.call(this,args);};
...
return G__11905__delegate(args);
});
...
var G__11889 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__11889 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__11889);
}
} else {
return null;
}
...
var renders_11915 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11916 = cljs.core.first(cljs.core.vals(renders_11915));
...
if((cljs.core.count(renders_11915) > (0))){
} else {
throw (new Error((""+"Assert failed: "+"Missing reagent-render"+"\n"+"(pos? (count renders))")));
}

if(((1) === cljs.core.count(renders_11915))){
} else {
throw (new Error((""+"Assert failed: "+"Too many render functions supplied"+"\n"+"(== 1 (count renders))")));
}

if(cljs.core.ifn_QMARK_(render_fun_11916)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Expected something callable, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11916], 0)))))+"\n"+"(clojure.core/ifn? render-fun)")));
}
...
var vec__11895 = module$node_modules$react$index.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11895,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11895,(1),null);
