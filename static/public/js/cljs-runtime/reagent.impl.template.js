...
var G__11914 = o;
reagent.impl.template.goog$module$goog$object.set(G__11914,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__11940__i < G__11940__a.length) {G__11940__a[G__11940__i] = arguments[G__11940__i + 0]; ++G__11940__i;}
  args = new cljs.core.IndexedSeq(G__11940__a,0,null);
} 
...
var G__11917 = o;
reagent.impl.template.goog$module$goog$object.set(G__11917,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__11943__i < G__11943__a.length) {G__11943__a[G__11943__i] = arguments[G__11943__i + 0]; ++G__11943__i;}
  args = new cljs.core.IndexedSeq(G__11943__a,0,null);
} 
...
var G__11918 = props;
var G__11918__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11918,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11918);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11918__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11919 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11919,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11919;
}
})(),id_class);
...
var temp__5823__auto___11945 = (function (){var and__5140__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___11945)){
var d_11946 = temp__5823__auto___11945;
if((d_11946 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_11946.s}));
} else {
...
var G__11920 = (cljs.core.count(argv) - first_child);
switch (G__11920) {
case (0):
...
var vec__11921 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11921,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11921,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11921,(2),null);
...
var temp__5827__auto___11954 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___11954 == null)){
} else {
var key_11955 = temp__5827__auto___11954;
(jsprops.key = key_11955);
}
...
var temp__5827__auto___11956 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___11956 == null)){
} else {
var key_11957 = temp__5827__auto___11956;
(jsprops.key = key_11957);
}
...
var temp__5827__auto___11958 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___11958 == null)){
} else {
var key_11959 = temp__5827__auto___11958;
(jsprops.key = key_11959);
}
...
var temp__5827__auto___11962 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___11962 == null)){
} else {
var key_11963 = temp__5827__auto___11962;
(jsprops.key = key_11963);
}
...
var temp__5827__auto___11973 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___11973 == null)){
} else {
var key_11974 = temp__5827__auto___11973;
(jsprops.key = key_11974);
}
...
var temp__5827__auto___11978 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___11978 == null)){
} else {
var key_11979 = temp__5827__auto___11978;
(jsprops.key = key_11979);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11929_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11929_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11930 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11930,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11930,(1),null);
...
break;
default:
var G__11991 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11992 = compiler;
v = G__11991;
compiler = G__11992;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template11936 = (function (opts,id,fn_to_element,parse_fn,meta11937){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11936.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11938,meta11937__$1){
var self__ = this;
var _11938__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11936(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11937__$1));
}));

(reagent.impl.template.t_reagent$impl$template11936.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11938){
var self__ = this;
var _11938__$1 = this;
return self__.meta11937;
}));

(reagent.impl.template.t_reagent$impl$template11936.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11936.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11936.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11936.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11936.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11936.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11937","meta11937",-839019055,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11936.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11936.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11936");

(reagent.impl.template.t_reagent$impl$template11936.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template11936");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11936.
 */
reagent.impl.template.__GT_t_reagent$impl$template11936 = (function reagent$impl$template$__GT_t_reagent$impl$template11936(opts,id,fn_to_element,parse_fn,meta11937){
return (new reagent.impl.template.t_reagent$impl$template11936(opts,id,fn_to_element,parse_fn,meta11937));
});
...
return (new reagent.impl.template.t_reagent$impl$template11936(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
