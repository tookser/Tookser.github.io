...
var i_14657 = (self__.level + (1));
while(true){
if((i_14657 <= (new_level + (1)))){
(update[i_14657] = self__.header);

var G__14661 = (i_14657 + (1));
i_14657 = G__14661;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14663 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14663[i]));
} else {
x__$2.forward.push((((i < links_14663.length))?(links_14663[i]):null));
}

if((i < links_14663.length)){
(links_14663[i] = x__$2);
} else {
links_14663.push(x__$2);
}
...
var i_14670 = (0);
while(true){
if((i_14670 <= self__.level)){
var links_14672 = (update[i_14670]).forward;
if((x__$1 === (((i_14670 < links_14672.length))?(links_14672[i_14670]):null))){
(links_14672[i_14670] = (x__$1.forward[i_14670]));

var G__14674 = (i_14670 + (1));
i_14670 = G__14674;
continue;
} else {
var G__14676 = (i_14670 + (1));
i_14670 = G__14676;
continue;
}
} else {
...
var G__14682 = nx;
var G__14683 = (level__$1 - (1));
x = G__14682;
level__$1 = G__14683;
continue;
} else {
var G__14684 = x;
var G__14685 = (level__$1 - (1));
x = G__14684;
level__$1 = G__14685;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14696 = nx;
var G__14697 = (level__$1 - (1));
x = G__14696;
level__$1 = G__14697;
continue;
} else {
var G__14704 = x;
var G__14705 = (level__$1 - (1));
x = G__14704;
level__$1 = G__14705;
continue;
}
